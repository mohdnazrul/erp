...
@section('page-content')
        ...
        <div class="row g-3">
            <div class="col-12">
                <h5>What is ApexCharts?</h5>
                <p>ApexChartsis loaded with powerful features to fulfill your data-visualization needs. For more info, please visit the <a class="link-primary" href="https://apexcharts.com/" target="_blank">plugin's site</a>. ApexCharts CSS and Javascript files are bundled in the global style and scripts bundles and are globally included in all pages:</p>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
          var options = {
            ...
            colors: ['var(--bs-primary)', '#ff7f81', '#e4bd51'],
            dataLabels: {
              enabled: false
            },
            series: [{
          ...
          var chart = new ApexCharts(document.querySelector("#apex-stacked-area"), options);
          chart.render();
        ...
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-basic-bar"), options);
          chart.render();
        });
        // BASIC CANDLESTICK
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-CandleStick"), options);
          chart.render();
        });
        // basic-column
        $(document).ready(function() {
        ...
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-basic-scatter"), options);
          chart.render();
        });
        // Basic Line Column
        $(document).ready(function() {
        ...
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-basic-radar"), options);
          chart.render();
        });
        ...
        $(document).ready(function() {
          var options = {
            ...
            colors: ['var(--bs-primary)', '#9E9896', '#ff7f81'],
            series: [{
              name: 'Series 1',
              data: [80, 50, 30, 40, 100, 20],
            }, {
        ...
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-radar-polygon-fill"), options);
          chart.render();
        });
        // SIMPLE DONUT
        $(document).ready(function() {
          var options = {
            ...
            colors: ['#004660', '#09536e', 'var(--bs-primary)', '#34738a'],
            series: [44, 55, 41, 17],
            responsive: [{
              breakpoint: 480,
              options: {
        ...
        $(document).ready(function() {
          var options = {
            ...
            colors: ['#004660', '#9E9896', '#ff7f81', '#44b39b'],
            plotOptions: {
              radialBar: {
                dataLabels: {
                  name: {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-circle-chart-multiple"), options);
          chart.render();
        });
        // circle gradient
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-circle-gradient"), options);
          chart.render();
        });
        // stroked gauge
        $(document).ready(function() {
          ...
          var chart = new ApexCharts(document.querySelector("#apex-stroked-gauge"), options);
          chart.render();
