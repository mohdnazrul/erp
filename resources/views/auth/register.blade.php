            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                <div class="w-100 px-lg-5 px-4 py-4" style="max-width: 420px;">
                    ...
                    <div class="text-center my-4">
                        <span class="text-muted opacity-50">or sign up with</span>
                    </div>

                    <!-- Register Form (Fortify POST /register) -->
                    <form method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary" title="Create an account">
                                Create an account
                            </button>
                        </div>
                    </form>
            ...
            <div class="col-lg-6 d-none d-lg-block p-0 overflow-hidden">
                <div class="d-flex justify-content-start">
                    <img style="object-fit: cover; height: 100vh;"
                         src="{{ asset('assets/images/login-image-dark.png') }}"
                         alt="Register image">
                </div>
            </div>
        </div>
